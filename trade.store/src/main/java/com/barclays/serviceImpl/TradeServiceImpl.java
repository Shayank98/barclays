...
public class TradeServiceImpl implements TradeService{
	...
	@Override
	public String addTrade(String tradeId, int version, String counterPartyId, String bookId, LocalDateTime maturityDate, LocalDateTime createdAt,String expired) throws MyException {
